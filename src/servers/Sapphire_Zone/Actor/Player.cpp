...
#include <src/servers/Common/Util/Util.h>
#include <src/servers/Common/Util/UtilMath.h>
#include <src/servers/Common/Config/XMLConfig.h>
#include <src/servers/Common/Network/GamePacket.h>
#include <src/servers/Common/Logging/Logger.h>
#include <src/servers/Common/Exd/ExdData.h>
#include <src/servers/Common/Network/PacketContainer.h>

#include "src/servers/Sapphire_Zone/Session.h"
#include "Player.h"
#include "BattleNpc.h"

#include "src/servers/Sapphire_Zone/Zone/ZoneMgr.h"
#include "src/servers/Sapphire_Zone/Zone/Zone.h"

#include "src/servers/Sapphire_Zone/ServerZone.h"

#include "src/servers/Sapphire_Zone/Network/GameConnection.h"

#include "src/servers/Sapphire_Zone/Network/PacketWrappers/ActorControlPacket142.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/ActorControlPacket143.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/InitUIPacket.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/ServerNoticePacket.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/ChatPacket.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/ModelEquipPacket.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/ActorSpawnPacket.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/UpdateHpMpTpPacket.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/PlayerStateFlagsPacket.h"
#include "src/servers/Sapphire_Zone/Network/PacketWrappers/PlayerSpawnPacket.h"

#include "src/servers/Sapphire_Zone/Script/ScriptManager.h"

#include "src/servers/Sapphire_Zone/StatusEffect/StatusEffectContainer.h"

#include "src/servers/Sapphire_Zone/Inventory/Item.h"

#include "src/servers/Sapphire_Zone/Inventory/Inventory.h"
#include "src/servers/Sapphire_Zone/Event/Event.h"
#include "src/servers/Sapphire_Zone/Action/Action.h"
#include "src/servers/Sapphire_Zone/Action/EventAction.h"
#include "src/servers/Sapphire_Zone/Action/EventItemAction.h"
#include "src/servers/Sapphire_Zone/Zone/ZonePosition.h"
#include "src/servers/Sapphire_Zone/Math/CalcStats.h"
#include "src/servers/Sapphire_Zone/Math/CalcBattle.h"
